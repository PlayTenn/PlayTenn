...
namespace PlayTen.BLL.DTO
{
    public class RegisterDTO
    {
        ...
        [Required(ErrorMessage = "Поле рівень гри є обов'язковим")]
        public string TennisLevelId { get; set; }

        [Required(ErrorMessage = "Це поле обов'язкове. Напишіть, будь ласка, як можна з Вами зв'язатись.")]
