        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipantStatusName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TennisLevels", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Places_Surfaces_SurfaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TennisLevelId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfParticipants = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HasBalls = table.Column<bool>(type: "bit", nullable: false),
                    PlaceId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ParticipantStatusId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Places",
                columns: new[] { "Id", "Name", "StreetAddress", "SurfaceId" },
                values: new object[,]
                {
                    { 1, "Динамо", "в. Янева, 10", 1 },
                    { 2, "ТЕН", "в. Болгарська, 4", 1 },
                    { 4, "Євроспорт", "пл. Петрушевича, 1", 1 },
                    { 5, "Іскра", "в. Вулицька, 14", 1 },
                    { 6, "Південний", "в. Щирецька, 36", 1 },
                    { 10, "Tennis Life", "в. Стрийська, 195 А", 1 },
                    { 13, "Брюховичі 2", "в. Пляжна, 2, Брюховичі", 1 },
                    { 14, "Цитадель", "в. Колесси, 8", 1 },
                    { 3, "ТЕН", "в. Болгарська, 4", 2 },
                    { 7, "Південний", "в. Щирецька, 36", 2 },
                    { 8, "Динамо", "в. Зелена, 59-63", 2 },
                    { 9, "Панська гора", " с. Сокільники", 2 },
                    { 11, "Tennis Life", "в. Стрийська, 195 А", 2 },
                    { 12, "Брюховичі 1", "в. Львівська, 80, Брюховичі", 4 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TennisLevelId",
                table: "AspNetUsers",
